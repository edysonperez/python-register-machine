...
class test_REGISTER_MACHINE(unittest.TestCase):
	...
	def test_CORRECT_NUMBER(self):	
		self.assertEqual(application.OPTION_ONE(1),"OPTION_ONE")
		self.assertEqual(application.OPTION_TWO(2),"OPTION_TWO")
		self.assertEqual(application.OPTION_THREE(3),"OPTION_THREE") 
	...
	def test_CHOISE_ENTER_PRODUCTS(self):
		self.assertNotEqual(application.ENTER_PRODUCTS_YES("y"),"ENTER_PRODUCTS") 
		self.assertNotEqual(application.ENTER_PRODUCTS_NOT("n"),"BACK_MENU")
